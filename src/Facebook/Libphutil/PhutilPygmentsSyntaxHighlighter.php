...
final class PhutilPygmentsSyntaxHighlighter {
  ...
  public function getHighlightFuture($source) {
    $language = \Facebook\Libphutil\Functions\utils::idx($this->config, 'language');
...
namespace Facebook\Libphutil;\n".$source;
      ...
      $future->write($source);
      return new \Facebook\Libphutil\PhutilDefaultSyntaxHighlighterEnginePygmentsFuture(
        $future,
        $source,
        $scrub);
    }
  ...
  private function getPygmentsLexerNameFromLanguageName($language) {
    ...
    return \Facebook\Libphutil\Functions\utils::idx($map, $language, $language);
  }
