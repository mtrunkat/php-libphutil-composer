...
class AphrontMySQLiDatabaseConnection
  ...
  public static function resolveAsyncQueries(array $conns, array $asyncs) {
    \Facebook\Libphutil\Functions\utils::assert_instances_of($conns, '\Facebook\Libphutil\AphrontMySQLiDatabaseConnection');
    \Facebook\Libphutil\Functions\utils::assert_instances_of($asyncs, '\mysqli');
