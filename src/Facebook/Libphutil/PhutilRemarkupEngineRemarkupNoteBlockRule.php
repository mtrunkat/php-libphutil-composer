 ...
 * @group markup
 */
class PhutilRemarkupEngineRemarkupNoteBlockRule
  ...
  public function markupText($text, $children) {
    ...
    if (\Facebook\Libphutil\Functions\utils::idx($matches, 'showword')) {
    ...
    $class_suffix = \Facebook\Libphutil\Functions\utf8::phutil_utf8_strtolower($word);
