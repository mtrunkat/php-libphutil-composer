...
abstract class PhutilChannel {
  ...
  public function __construct() {
    $this->obuf = new \Facebook\Libphutil\PhutilRope();
  }
...
/* -(  Waiting for Activity  )----------------------------------------------- */
  ...
  public static function waitForActivity(
    ...
    \Facebook\Libphutil\Functions\utils::assert_instances_of($reads, '\Facebook\Libphutil\PhutilChannel');
    \Facebook\Libphutil\Functions\utils::assert_instances_of($writes, '\Facebook\Libphutil\PhutilChannel');

    $read   = \Facebook\Libphutil\Functions\utils::idx($options, 'read',     array());
    $write  = \Facebook\Libphutil\Functions\utils::idx($options, 'write',    array());
    $except = \Facebook\Libphutil\Functions\utils::idx($options, 'except',   array());
    $wait   = \Facebook\Libphutil\Functions\utils::idx($options, 'timeout',  1);
...
/* -(  Channel Implementation  )--------------------------------------------- */
  ...
  public function getName() {
    return \Facebook\Libphutil\Functions\utils::coalesce($this->name, get_class($this));
  }
