...
class PhutilJavaCodeSnippetContextFreeGrammar
  extends \Facebook\Libphutil\PhutilCLikeCodeSnippetContextFreeGrammar {
  ...
  protected function getExprGrammarSet() {
    ...
    // Add some 'char's
    for ($ii = 0; $ii < 2; $ii++) {
      $expr['expr'][] = "'".\Facebook\Libphutil\Filesystem::readRandomCharacters(1)."'";
    }
  ...
  protected function getMethodNameGrammarSet() {
    $funcnames = \Facebook\Libphutil\Functions\utils::head(parent::getFuncNameGrammarSet());
