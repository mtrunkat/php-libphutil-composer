 ...
 */
abstract class PhutilAuthAdapterOAuth extends \Facebook\Libphutil\PhutilAuthAdapter {
  ...
  public function getAuthenticateURI() {
    $uri = new \Facebook\Libphutil\PhutilURI($this->getAuthenticateBaseURI());
  ...
  public function getAdapterType() {
    ...
    $type_name = str_replace('\Facebook\Libphutil\PhutilAuthAdapterOAuth', '', $this_class);
  ...
  public function setClientSecret(\Facebook\Libphutil\PhutilOpaqueEnvelope $client_secret) {
  ...
  protected function getAccessTokenData($key, $default = null) {
    ...
    return \Facebook\Libphutil\Functions\utils::idx($this->accessTokenData, $key, $default);
  }
  ...
  private function makeTokenRequest(array $params) {
    ...
    $future = new \Facebook\Libphutil\HTTPSFuture($uri, $query_data);
  ...
  protected function getOAuthAccountData($key, $default = null) {
    ...
    return \Facebook\Libphutil\Functions\utils::idx($this->oauthAccountData, $key, $default);
  }
