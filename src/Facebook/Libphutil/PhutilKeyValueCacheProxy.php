...
abstract class PhutilKeyValueCacheProxy extends \Facebook\Libphutil\PhutilKeyValueCache {

  private $proxy;

  final public function __construct(\Facebook\Libphutil\PhutilKeyValueCache $proxy) {
    $this->proxy = $proxy;
    return $this;
  }
