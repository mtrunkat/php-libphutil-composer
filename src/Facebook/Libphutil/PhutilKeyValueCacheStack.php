...
/* -(  Configuring the Stack  )---------------------------------------------- */
  ...
  public function setCaches(array $caches) {
    \Facebook\Libphutil\Functions\utils::assert_instances_of($caches, '\Facebook\Libphutil\PhutilKeyValueCache');
...
/* -(  Key-Value Cache Implementation  )------------------------------------- */
  ...
  public function getKeys(array $keys) {
    ...
    $remaining = \Facebook\Libphutil\Functions\utils::array_fuse($keys);
    $results = array();
    $missed = array();
