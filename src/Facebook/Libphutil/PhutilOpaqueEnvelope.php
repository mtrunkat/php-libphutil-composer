 ...
 *
 *   $envelope = new \Facebook\Libphutil\PhutilOpaqueEnvelope($password);
 *   do_stuff($envelope);
 *   // ...
...
/* -(  Using Opaque Envelopes  )--------------------------------------------- */
  ...
  public function __construct($string) {
    $this->value = $this->mask($string, \Facebook\Libphutil\PhutilOpaqueEnvelopeKey::getKey());
  }
  ...
  public function openEnvelope() {
    return $this->mask($this->value, \Facebook\Libphutil\PhutilOpaqueEnvelopeKey::getKey());
  }
