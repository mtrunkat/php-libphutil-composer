 ...
 * executed commands.
 *
 *   foreach (new \Facebook\Libphutil\LinesOfALargeFile('/some/large/logfile.log') as $line) {
 *     // ...
 *   }
 *
...
/* -(  Construction  )------------------------------------------------------- */
  ...
  public function __construct($file_name) {
    $this->fileName = \Facebook\Libphutil\Filesystem::resolvePath((string)$file_name);
  }
