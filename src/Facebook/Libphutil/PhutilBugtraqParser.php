 ...
 * ...you can use:
 *
 *   $message = \Facebook\Libphutil\Functions\utils::id(new \Facebook\Libphutil\PhutilBugtraqParser())
...
final class PhutilBugtraqParser {
  ...
  public function setBugtraqCaptureExpression($regex) {
    \Facebook\Libphutil\PhutilTypeSpec::newFromString('regex')->check($regex);
