 ...
 * line scripts.
 *
 *   $exec = new \Facebook\Libphutil\PhutilExecPassthru('ls %s', $dir);
 *   $err = $exec->execute();
 *
...
/* -(  Executing Passthru Commands  )---------------------------------------- */
  ...
  public function __construct($pattern /* , ... */) {
    $args = func_get_args();
    $this->command = call_user_func_array('\Facebook\Libphutil\Functions\csprintf::csprintf', $args);
  }
  ...
  public function execute() {
    ...
    if ($command instanceof \Facebook\Libphutil\PhutilCommandString) {
