...
/**
 * Wraps another \Facebook\Libphutil\Future and allows you to post-process its result once it
 * resolves.
 *
 * @group futures
 * @stable
 */
abstract class FutureProxy extends \Facebook\Libphutil\Future {

  private $proxied;

  public function __construct(\Facebook\Libphutil\Future $proxied = null) {
    if ($proxied) {
      $this->setProxiedFuture($proxied);
    }
  }

  public function setProxiedFuture(\Facebook\Libphutil\Future $proxied) {
