...
final class PhutilDivinerSyntaxHighlighter {
  ...
  public function getHighlightFuture($source) {
    ...
    $source = \Facebook\Libphutil\Functions\render::phutil_escape_html($source);
    ...
    $source = \Facebook\Libphutil\Functions\render::phutil_safe_html($source);
    return new \Facebook\Libphutil\ImmediateFuture($source);
  }
