...
final class PhutilArgumentSpecification {
   ...
   *
   *    $spec = \Facebook\Libphutil\PhutilArgumentSpecification::newQuickSpec(
   *      array(
   *        'name'  => 'verbose',
   *        'short' => 'v',
   *      ));
   ...
   * @return \Facebook\Libphutil\PhutilArgumentSpecification Constructed argument specification.
   */
  public static function newQuickSpec(array $spec) {
    ...
    $obj = new \Facebook\Libphutil\PhutilArgumentSpecification();
  ...
  public static function newSpecsFromList(array $specs) {
    foreach ($specs as $key => $spec) {
      if (is_array($spec)) {
        $specs[$key] = \Facebook\Libphutil\PhutilArgumentSpecification::newQuickSpec(
          $spec);
      }
    }
    return $specs;
