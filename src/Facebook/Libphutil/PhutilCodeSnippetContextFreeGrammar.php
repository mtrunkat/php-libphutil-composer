...
abstract class PhutilCodeSnippetContextFreeGrammar
  ...
  final protected function getRules() {
    return array_merge(
      ...
      \Facebook\Libphutil\Functions\utils::array_mergev($this->buildRuleSet()));
  }
  ...
  protected function getFuncNameGrammarSet() {
    return $this->buildGrammarSet('funcname',
      array(
        'do_something',
        '\Facebook\Libphutil\Functions\utils::nonempty',
        'noOp',
        'call_user_func',
        'getenv',
        'render',
  ...
  protected function getExprGrammarSet() {
    return $this->buildGrammarSet('expr',
      array(
        ...
        '[arithexpr]',
        // Some random strings
        '"'.\Facebook\Libphutil\Filesystem::readRandomCharacters(4).'"',
        '"'.\Facebook\Libphutil\Filesystem::readRandomCharacters(5).'"',
      ));
  }
