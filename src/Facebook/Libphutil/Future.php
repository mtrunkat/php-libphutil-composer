...
abstract class Future {
   ...
   * @return mixed \Facebook\Libphutil\Future result, or null if the timeout is hit.
   */
  ...
  public static function waitForSockets(
    ...
    if (!self::$handlerInstalled) {
      ...
      if (function_exists('pcntl_signal')) {
        if (!pcntl_signal(SIGCHLD, array('\Facebook\Libphutil\Future', 'handleSIGCHLD'))) {
   ...
   * primitive transport futures (like CurlFuture and \Facebook\Libphutil\ExecFuture) which can
