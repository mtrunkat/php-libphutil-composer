 ...
 *    \Facebook\Libphutil\Filesystem::writeFile($temp, 'Hello World');
 *    echo "Wrote data to path: ".$temp;
 *
 * Throws \Facebook\Libphutil\Filesystem exceptions for errors.
 *
...
/* -(  Creating a Temporary File  )------------------------------------------ */
  ...
  public function __construct($filename = null) {
    $this->dir = \Facebook\Libphutil\Filesystem::createTemporaryDirectory();
    if ($filename === null) {
    ...
    \Facebook\Libphutil\Filesystem::writeFile($this, '');
  }
...
/* -(  Internals  )---------------------------------------------------------- */
  ...
  public function __destruct() {
    ...
    \Facebook\Libphutil\Filesystem::remove($this->dir);
    ...
    \Facebook\Libphutil\Filesystem::remove($this->file);
  }
