 ...
 *   // needs to be done.
 *   $bar = \Facebook\Libphutil\Functions\utils::id(new \Facebook\Libphutil\PhutilConsoleProgressBar())
...
final class PhutilConsoleProgressBar extends \Facebook\Libphutil\Phobject {
  ...
  public function setConsole(\Facebook\Libphutil\PhutilConsole $console) {
  ...
  private function getConsole() {
    ...
    return \Facebook\Libphutil\PhutilConsole::getConsole();
  }
  ...
  private function getWidth() {
    ...
    return min(\Facebook\Libphutil\Functions\utils::nonempty($width, 78), 78);
  }
